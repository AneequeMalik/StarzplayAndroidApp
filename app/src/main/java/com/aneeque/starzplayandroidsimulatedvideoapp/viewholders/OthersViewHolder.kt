...
class OthersViewHolder(
    ...
    fun bind(others: ArrayList<MediaDetails>) {
        binding.layoutTitle.tvMediaTitle.text = itemView.context.getString(R.string.header_others)
        setupHorizontalRecyclerView(others, binding)
    }
